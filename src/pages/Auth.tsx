...
const Auth = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      } else if (error.message.toLowerCase().includes("pwned") || error.message.toLowerCase().includes("compromised") || error.message.toLowerCase().includes("breach")) {
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-lg">
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <button type="button" onClick={() => setForgotOpen((v) => !v)} className="text-xs text-primary hover:underline">
                      Forgot password?
                    </button>
                  </div>
                  <div className="relative">
              ...
              {forgotOpen && (
                <form onSubmit={handleForgot} className="mt-4 p-4 bg-secondary/50 rounded-lg space-y-3">
                  <Label htmlFor="forgot-email" className="text-sm">Reset your password</Label>
